...
const AllTask = () => {
    ...
    return (
        <div className='bg-[#1c1c1c] p-5 rounded mt-5'>
            <div className='bg-orange-700 mb-2 py-2 px-4 flex justify-between rounded'>
            ...
            {userData.map(function(elem, idx){
                return <div key={idx} className='border-2 border-slate-600 mb-2  py-2 px-4 flex justify-between rounded'>
